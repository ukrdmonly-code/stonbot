...
CATEGORIES_BY_GENDER = {
    "чоловік": {
        ...
        "Кофти": ["кофта", "кофта на флісі", "кофти"],
        "Для тренувань": ["компресійні штани", "компресійні кофти", "термо кофта", "термо", "тайтси", "компресійний"],
        "Лонгслів": ["лонгслів", "лонгсліви", "longsleeve", "лонг слив"]
    },
    "жінка": {
        "Куртки": ["куртка", "куртки", "jacket", "пуховик", "вітрівка", "вітровка", "бомбер"],
        "Жилетки": ["жилетка", "жилет", "жилетки", "vest"],
...
SEASONS = {
    "❄️ Зима": ["зима", "зимовий", "зимня", "winter", "пуховик", "теплий", "зимова"],
    "🌞 Літо": ["літо", "літній", "літня", "summer", "спекотно", "легкий", "пляж"],
    "🍂 Демісезон": ["демісезон", "весна", "осінь", "spring", "autumn", "дощ", "вітровка"]
}
